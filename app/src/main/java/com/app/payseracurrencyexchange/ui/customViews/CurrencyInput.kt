...
/**
 * This class change the input Amount format for currency.
 * reference : https://github.com/zihadrizkyef/TextWatcherForMoney
 */
class CurrencyInput(private val editText: EditText) : TextWatcher {
        companion object {
            fun applyTo(
                editText: EditText,
                moneyPrefix: String = "$ ",
                ...
                val watcher = CurrencyInput(editText).apply {
